...
# Main label text:
brandLabel = tk.Label(root, text="All Employee Information", font="montserrat 30", bg="gray17", fg="white")
brandLabel.place(x=300, y=50)

#Try

empTable = tk.Frame(root, bg="gray17", height=1000, width=300)
empTable.place(x=300, y=200)
header=["id","Employee Code", "First Name", "Middle Name", "Last Name", "Dept ID", "Position ID", "Salary"]
...
for employee in r_set:
    for j in range(len(employee)):
        e=tk.Label(empTable, width=10, fg='blue',text= employee[j], anchor='w')
